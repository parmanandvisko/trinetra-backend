...
const settingsSchema = new mongoose.Schema({
  ...
  address: { type: String, default: 'Flat No 708, O Wing, Mohan Nano Estates, Khutavali, Ambernath West, Ambarnath, Thane, Maharashtra - 421501', maxlength: 180 },
  logoUrl: { type: String, default: '', maxlength: 250 },
  gstNumber: { type: String, default: 'GSTIN: 27AHNPN4301P1ZW', maxlength: 80 },
  businessRegistration: { type: String, default: 'Legal Name: DAVASI MUTHU NADAR | Constitution: Proprietorship', maxlength: 80 },
